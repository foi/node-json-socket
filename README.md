...
Developed by @sebastianseilund but forked because unicode patch by @hpalz is not accepted. This repo includes unicode patch. Also added promise based sendReceive method.
